...
const IntroStartScanning: React.FC<NavigationStackScreenProps> & {
          ...
          <Container padding={Metrics.spacing.screen.default}>
            ...
            <Container marginTop={Metrics.spacing.vertical.small}>
              <Text type={Constants.TextTypes.Body}>
                Your ID will be scanned from front to back. Please take a
                picture of your ID and focus it inside the marker.
              </Text>
            </Container>
            <Text
...
IntroStartScanning.navigationOptions = ({ navigation }: any) => {
  return {
    headerShown: false,
  }
}

export default IntroStartScanning
