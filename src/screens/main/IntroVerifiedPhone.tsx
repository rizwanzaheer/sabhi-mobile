...
const IntroVerifiedPhone: React.FC<NavigationStackScreenProps> & {
          ...
          <Container padding={Metrics.spacing.screen.default}>
            ...
            <Container marginTop={Metrics.spacing.vertical.small}>
              <Text type={Constants.TextTypes.Body}>
                Phone verification was successful. Two-factor authentication has
        ...
        >
          <Container w={300}>
            <Button
              ...
              buttonText={'Next'}
              onPress={() => navigation.navigate('IntroEnableBiometrics')}
            />
          </Container>
        </Container>
      </Screen>
...
IntroVerifiedPhone.navigationOptions = ({ navigation }: any) => {
  return {
    headerShown: false,
  }
}

export default IntroVerifiedPhone
