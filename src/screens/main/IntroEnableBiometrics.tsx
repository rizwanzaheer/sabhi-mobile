...
const IntroEnableBiometrics: React.FC<NavigationStackScreenProps> & {
          ...
          <Container padding={Metrics.spacing.screen.default}>
            ...
            <Container marginTop={Metrics.spacing.vertical.small}>
              <Text type={Constants.TextTypes.Body}>
                You can enable biometric log-in to make your account more secure
                by prompting your biometric credentials.
              </Text>
            </Container>
          </Container>
        </Container>
...
IntroEnableBiometrics.navigationOptions = ({ navigation }: any) => {
  return {
    headerShown: false,
  }
}

export default IntroEnableBiometrics
